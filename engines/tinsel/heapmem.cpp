 ...
 * $Id: heapmem.cpp 35648 2009-01-01 15:06:43Z sev $
 *
...
uint32 MemoryPoolSize[4] = {5 * 1024 * 1024, 5 * 1024 * 1024, 10 * 1024 * 1024, 50 * 1024 * 1024};
...
void MemoryInit(void) {
	...
	else if (TinselV3) size = MemoryPoolSize[3];
