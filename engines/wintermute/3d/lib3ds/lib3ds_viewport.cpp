...
lib3ds_viewport_write(Lib3dsViewport *viewport, Lib3dsIo *io) {
	if (viewport->layout_nviews) {
		...
		lib3ds_io_write_word(io, (uint16)viewport->layout_style);
		lib3ds_io_write_intw(io, (int16)viewport->layout_active);
		lib3ds_io_write_intw(io, 0);
		lib3ds_io_write_intw(io, (int16)viewport->layout_swap);
		lib3ds_io_write_intw(io, 0);
		lib3ds_io_write_intw(io, (int16)viewport->layout_swap_prior);
		lib3ds_io_write_intw(io, (int16)viewport->layout_swap_view);
		...
		for (i = 0; i < viewport->layout_nviews; ++i) {
			...
			lib3ds_io_write_intw(io, 0);
			lib3ds_io_write_word(io, (uint16)viewport->layout_views[i].axis_lock);
			lib3ds_io_write_intw(io, (int16)viewport->layout_views[i].position[0]);
			...
			lib3ds_io_write_word(io, (uint16)viewport->layout_views[i].type);
